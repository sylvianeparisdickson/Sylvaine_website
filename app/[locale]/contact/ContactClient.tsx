      ...
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-0 md:min-h-screen">
        ...
        <div className="flex flex-col justify-center px-6 md:px-16 py-16 md:py-24 bg-[#faf9f6] overflow-y-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[9px] tracking-[.2em] uppercase text-[#9a9188]">{t("orSend")}</span>
            <span className="flex-1 h-px bg-black/10" />
          </div>
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="flex flex-col gap-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
                {[
                  { label: t("formFirstName"), name: "first_name", type: "text", placeholder: t("formFirstNamePlaceholder") },
                  { label: t("formLastName"),  name: "last_name",  type: "text", placeholder: t("formLastNamePlaceholder")  },
                ].map((f) => (
              ...
              {[
                { label: t("formEmail"),   name: "email",   type: "email", placeholder: "your@email.com",                       required: true  },
                { label: t("formSubject"), name: "subject", type: "text",  placeholder: t("formSubjectPlaceholder"),  required: false },
              ].map((f) => (
                <div key={f.name} className="group flex flex-col border-b border-black/10 relative">
                  <label className="text-[8.5px] tracking-[.22em] uppercase text-[#9a9188] mt-5 mb-2">{f.label}</label>
              ...
              <div className="group flex flex-col border-b border-black/10 relative">
                <label className="text-[8.5px] tracking-[.22em] uppercase text-[#9a9188] mt-5 mb-2">{t("formMessage")}</label>
                <textarea name="message" placeholder={t("formMessagePlaceholder")} required rows={4}
            ...
            <div className="flex flex-col items-center justify-center text-center py-10">
              ...
              <p className="font-serif italic text-[24px] text-[#1a1816] mb-3">{t("formSubmittedTitle")}</p>
