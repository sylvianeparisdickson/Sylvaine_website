...
export default function Footer() {
  return (
    <>
      {/* Studio strip */}
      <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-2 px-6 md:px-14 py-6 md:py-8 bg-[#f8f5ef] border-t border-b border-black/10 text-center sm:text-left">
        <p className="font-serif italic text-[13px] sm:text-[14px] md:text-[15px] text-[#6a6560] max-w-md">Permanent exhibition open to visitors</p>
