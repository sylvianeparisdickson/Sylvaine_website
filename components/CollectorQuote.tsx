export default function CollectorQuote() {
  return (
    <section className="px-6 md:px-14 py-12 sm:py-16 md:py-24 max-w-3xl mx-auto text-center border-t border-black/10 reveal">
      <span className="block font-serif text-[40px] sm:text-[52px] md:text-[64px] leading-[0.6] text-black/10 mb-4 sm:mb-5">"</span>
